 ...
 * @returns {string}
 */
export function parsePhoneticToEnglish(phonetic) {
 ...
 * @returns {string}
 */
function convertBeginningJ(phonemes) {
 ...
 * @returns {string}
 */
function convertEndOfSyllableJ(phonemes) {
 ...
 * @returns {string}
 */
export function convertPhonemesToEnglish(phonemes) {
  if (!phonemes) return '';
